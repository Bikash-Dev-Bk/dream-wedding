        ...
        <div >
            ...
            <div className="max-w-7xl mx-auto flex gap-5 flex-col md:flex-row items-center my-32 p-5 md:p-4 lg:p-2">
                ...
                <div className="flex md:justify-end flex-1">
                    <img src={image} alt="" className="rounded-tr-[60px] rounded-bl-[60px] md:rounded-tr-[100px] md:rounded-bl-[100px] border-4 border-[#8ECDDD] hover:shadow-2xl hover:shadow-[#8ECDDD]" />
                </div>
            </div>
        </div>
    );
