...
const Services = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <p className="max-w-4xl mx-auto text-center text-lg my-5">From full wedding planning to individual services like venue selection, decor, catering, entertainment, and more, we tailor each detail to your vision. Trust us to make your dream wedding a reality, ensuring every moment is unforgettable. Your wedding journey starts here.</p>
